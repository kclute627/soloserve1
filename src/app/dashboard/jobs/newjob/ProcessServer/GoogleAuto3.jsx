...
import { handleContractorInput3, setGoogleAddressContractor } from "../../../../Redux/actions";

function GoogleAuto3({ address = { client_address: { street: "", suite: "", city: "", state: "", zip: "" } } }) {
  ...
  const fillInAddress = (autocomplete) => {
    ...
    dispatch(setGoogleAddressContractor({ ...parsedAddress }));
  };

  const handleAddressChange = (e) => {
    dispatch(handleContractorInput3("street", e.target.value));
  };
      ...
      <div className="">
        ...
        <div className="mt-2">
          <input
            ...
            id="ship-address"
            type="text"
            value={address.client_address.street || ""}
            autoComplete="off"
            onFocus={onFocus}
            ref={addressRef}
