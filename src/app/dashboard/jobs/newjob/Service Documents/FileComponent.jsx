...
const FileComponent = ({
  ...
  const baseClass = `px-4 py-4 h-[13rem] w-full md:w-[35rem] rounded-xl border border-slate-700 p-5 drop-shadow-xl flex bg-slate-200 relative z-0`;
  ...
  return (
    ...
    <div
      className={`${baseClass} ${i == 0 ? "bg-primaryGreen/30" : "bg-slate-300"}`}
      key={file.id}
    >
      ...
      <div className="w-full font-poppins">
        ...
        <div className="flex items-center w-full space-x-2 mt-1">
          <div className=" relative z-0 w-[95%]">
            {inputValue ? (
              <div
                className="absolute z-40 top-2 right-2  h-6 w-6 "
            ...
            <input
              ...
              className=" w-full rounded-md border-0 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-lg sm:leading-6 relative z-[9] pr-10 py-2 text-sm font-poppins"
          ...
          <button onClick={(e) => handleDeleteFile(e, file.id)}>
            <div className="text-red-500 hover:text-red-600 bg-white p-1 rounded-md">
              <svg
          ...
          {i === 0 && (
            <button>
              <div className="text-teal-700 hover:text-teal-500 bg-white p-1 rounded-md">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
          ...
          {i === length - 1 && (
            <button onClick={(e) => handleAddNoFile(e)}>
              <div className="text-slate-700 bg-white p-1 rounded-md">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
        ...
        {newFile && (
          <div className=" mt-2 text-sm font-medium leading-6 text-gray-900">
            <div className="flex overflow-x-auto">
              <div className="mr-2 text-nowrap font-bold">File Name:</div>
