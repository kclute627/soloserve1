...
/*
 <div className="lg:pl-72">
<div className="sticky top-0 z-40 flex justify-between h-16 shrink-1 items-center gap-x-4 border-b border-gray-200 bg-white px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-8">
  <div className=" flex justify-between h-16 items-center gap-x-4 border-b border-gray-200 bg-white px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-0 lg:shadow-none">
    <button
      type="button"
      className="-m-2.5 p-2.5 text-gray-700 lg:hidden"
      onClick={() => setSidebarOpen(true)}
    ...
    // <div className="flex w-full flex-1 gap-x-4 self-stretch lg:gap-x-6">
    //   <form className="relative flex flex-1" action="#" method="GET">
    //     <label htmlFor="search-field" className="sr-only">
    //       Search
    //     </label>
